...
최근 AI가 매우 빠르게 발전하고 있는 시기다보니 AI에 대한 뉴스와 관련 기업들의 행보도 점점 다양해지는 것 같다.

특정 기업에서 기술의 주도권을 잡고 있는 시기에 어떤 기업은 그에 대해서 역풍을 강하게 맞기도 하는데 나는 인공지능과 관련하여 어떤 커리어를 밟아나갈 수 있을지도 고민이 된다.

또한 기술만이 아닌 AI 윤리도 계속 부상하고 있는 주제인데 관련된 다양한 분야에 걸쳐있을 필요가 있을 것 같다는 생각도 든다.